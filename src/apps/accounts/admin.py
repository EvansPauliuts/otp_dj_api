...
class UserAdmin(admin.ModelAdmin[User]):
    ...
    def _add_view(
        ...
        username_field = self.model._meta.get_field(  # noqa: SLF001
    ...
    def user_change_password(
        ...
        if user is None:
            raise Http404(
                f'{self.model._meta.verbose_name} object '  # noqa: SLF001
        ...
        adminForm = admin.helpers.AdminForm(form, fieldsets, {})  # noqa: N806
